export const data = {
    recommendations: [
        ...
        {
            text: `Rajat is a great partner to work with. Being a fast learner helped him understand the market fit and quickly choose the right path to success. He has an amazing quality of being patient which helped us during the times of work pressure.
